...
#import "NCHefeFilter.h"

NSString *const kNCHefeShaderString = SHADER_STRING
(
...
@implementation NCHefeFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCHefeShaderString]))
    {
		return nil;
    }
