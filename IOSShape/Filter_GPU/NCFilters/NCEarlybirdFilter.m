...
#import "NCEarlybirdFilter.h"

NSString *const kNCEarlybirdShaderString = SHADER_STRING
(
...
@implementation NCEarlybirdFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCEarlybirdShaderString]))
    {
		return nil;
    }
