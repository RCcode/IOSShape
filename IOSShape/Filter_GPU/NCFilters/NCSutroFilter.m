...
#import "NCSutroFilter.h"

NSString *const kNCSutroShaderString = SHADER_STRING
(
...
@implementation NCSutroFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCSutroShaderString]))
    {
		return nil;
    }
