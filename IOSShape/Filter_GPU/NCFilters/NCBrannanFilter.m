...
#import "NCBrannanFilter.h"

NSString *const kNCBrannanShaderString = SHADER_STRING
(
...
@implementation NCBrannanFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCBrannanShaderString]))
    {
		return nil;
    }
