...
#import "NCValenciaFilter.h"


NSString *const kNCValenciaShaderString = SHADER_STRING
(
...
@implementation NCValenciaFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCValenciaShaderString]))
    {
		return nil;
    }
...
//- (void)dealloc{
//    NSLog(@"IFValenciaFilter - dealloc");
//}
