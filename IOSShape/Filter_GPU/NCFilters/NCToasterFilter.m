...
#import "NCToasterFilter.h"

NSString *const kNCToasterShaderString = SHADER_STRING
(
...
@implementation NCToasterFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCToasterShaderString]))
    {
		return nil;
    }
