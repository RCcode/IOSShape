...
- (void)didTouchedLabel:(NSInteger)tag;
...
@optional
- (void)touchDoneWithExitLabel:(NSString *)content textAligment:(enum TextAligment)aligment;
 ...
 *  @param type    滤镜类型
 */
- (void)filterToolBar:(PRJ_FilterToolBarView *)toolBar DidSelectedItemWithFilterType:(const float *)type;
